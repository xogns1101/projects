...
<script>
    ...
    function renderReplies(replyList){
        ...
        // 객체 디스트럭처링(댓글 수, 페이지메이커, 댓글목록으로 분해)
    ...
    function makePageButtonClickHandler(){
        ...
        $pageUl.onclick = e =>{
            ...
            // 이벤트 타겟이 a 태그가 아니면 href 속성을 못가져 올 수 있으니 타겟 제한하기
    ...
    function makeReplyRemoveClickHandler(){
        ...
        $replyData.onclick = e => {
            ...
            // 이벤트가 발생된 곳(수정, 삭제버튼)에서 가장 가까운 #replyContent
            // 에 붙은 댓글 번호 가져오기
            ...
            if(e.target.matches('#replyDelBtn')){
                // 삭제 로직 진행
                /*
                    confirm함수를 사용해서 한번더 물어보기
                    

                    URL : /api/v1/replies/rno : DELETE , 전달되는 JSON은 없음
                    headers , body 는 작성할 필요가 없음
                ...
                */
                ...
                // 아까 읽어놓은 댓글번호도 모달 안에 있는 input hidden 에 집어넣기
