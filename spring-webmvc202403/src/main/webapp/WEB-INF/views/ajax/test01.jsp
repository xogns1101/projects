...
<body>
    ...
    <script>
        ...
        $sendBtn.addEventListener('click', e => {
           ...
           // 3. 서버로 전송할 데이터를 재작
           // 제작하는 데이터의 형식은 JSON 형태여야 함
           // 자바 서버는 자바스크립트 형태의 데이터를 알 수가 없음 
           // -> 공통된 표기 방식으로 바꿔서 전송 해야함
            const data ={
            ...
            }; // 이 객체는 아직 JSON이 아님 JavaScript 객체임

            // JS -> JSON 으로 변환 : JSON.stringify(obj)
