...
<div class="wrap">
    <section class="score-main">
        <h1>${detail.name}님 성적 정보 수정하기~</h1>
        <form action="/score/modify" method="post">
            <input type="hidden" name="stuNum" value="${detail.stuNum}">
            <ul>
                <li># 국어: <input type="text" name="kor" value="${detail.kor}"></li>
                <li># 영어: <input type="text" name="eng" value="${detail.eng}"></li>
                <li># 수학: <input type="text" name="math" value="${detail.math}"></li>
            </ul>
            <div class="btn-group">
