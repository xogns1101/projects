...
public class UploadCotroller {
    ...
    // 경로는 왠만하면 한글을 쓰지 말것!
    private String rootPath = "C:/workspace/upload";
    ...
    public String uploadForm(@RequestParam("thumbnail") MultipartFile file){
        ...
        log.info("/upload-file : POST , file = {}", file.getOriginalFilename());
        // KB로 표현 하고 싶을때
        // -> file.getSize() 에 1024.0 를 나누어 주면 된다!
