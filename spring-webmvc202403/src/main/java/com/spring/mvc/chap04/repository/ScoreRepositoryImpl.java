...
@Repository // Bean으로 등록해놔야 Service에 주입이 가능하다
...
public class ScoreRepositoryImpl implements ScoreRepository{
    ...
    // Spring-jdbc 의 핵심 객체인 JdbcTemplate의 의존성 주입(생성자 주입)
    ...
    public boolean save(Score score) {
        ...
        // 요렇게 해도 무방함 (참고 할것!)
//        return jdbcTemplate.update(sql, score.getName(), score.getKor()
//                , score.getEng(), score.getMath(), score.getTotal()
//                , score.getAverage(), score.getGrade().toString()) == 1;
    ...
    public List<Score> findAll(String sort) {
        ...
        List<Score> list = jdbcTemplate.query(sql, new ScoreMapper());
    ...
    public void update(Score changeScore) {
        ...
        jdbcTemplate.update(sql, changeScore.getKor(),
                changeScore.getEng(), changeScore.getMath(),
